...
namespace Locust.Data
{
    ...
    public static class DataReaderExtensions
    {
        ...
        /// </param>
        /// <returns></returns>
        public static List<TType> DataReaderToObjectList<TType>(this IDataReader reader, Type type = null, string fieldsToSkip = null, Dictionary<string, PropertyInfo> piList = null)
            where TType : new()
        {
            if (reader == null)
                return null;
            ...
            while (reader.Read())
            {
                ...
                DataReaderToObject(reader, ref inst, type, fieldsToSkip, piList);
