...
{
    public class FakeInternetExplorerBrowserCapabilities: FakeHttpBrowserCapabilities
    {
        public FakeInternetExplorerBrowserCapabilities()
        {
            ...
            SetBrowsers(new ArrayList { "default", "mozilla", "internetexplorer" });
            ...
            SetId("internetexplorer");
            SetInputType("keyboard");
            SetIsColor(true);
            SetIsMobileDevice(false);
            SetJavaApplets(false);
            SetMajorVersion(11);
            ...
            SetSupportsAccesskeyAttribute(false);
