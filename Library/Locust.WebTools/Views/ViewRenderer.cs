...
{
    // source: https://weblog.west-wind.com/posts/2012/May/30/Rendering-ASPNET-MVC-Views-to-String
    /// <summary>
    ...
    {
        public class ViewRendererDefaultController:ClientAwareControllerBase
        {
            public ViewRendererDefaultController() { }
        ...
        public ViewRenderer(ControllerContext controllerContext = null)
        {
            ...
            if (controllerContext == null)
            {
                if (HttpContext.Current != null)
                    controllerContext = CreateController<ViewRendererDefaultController>().ControllerContext;
                else
