...
namespace Locust.Modules.Api.Model.Api
{
    public class Full: BaseModel
    {
        ...
        private IList<Model.ApiSetting.Full> _settings;
        public IList<Model.ApiSetting.Full> Settings
        {
            get
            {
                if (_settings == null)
                    _settings = new List<Model.ApiSetting.Full>();
                return _settings;
            }
            set { _settings = value; }
        }
