...
{
	public partial class ApiClientGetApisStrategy : ApiClientGetApisStrategyBase
    {
		public ApiClientGetApisStrategy ():base()
		{
			Init();
		}
		public override void Run(ApiClientGetApisContext context)
		{
            Execute(context);
		...
		public override Task RunAsync(ApiClientGetApisContext context)
		{
