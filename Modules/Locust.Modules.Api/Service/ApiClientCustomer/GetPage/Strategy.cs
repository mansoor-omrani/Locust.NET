...
{
	public partial class ApiClientCustomerGetPageStrategy : ApiClientCustomerGetPageStrategyBase
    {
		public ApiClientCustomerGetPageStrategy ()
		{
			Init();
		}
		public override void Run(ApiClientCustomerGetPageContext context)
		{
			Execute(context);
		...
		public override Task RunAsync(ApiClientCustomerGetPageContext context)
		{
