...
{
	public partial class ApiClientCustomerHubGetPageStrategy : ApiClientCustomerHubGetPageStrategyBase
    {
		public ApiClientCustomerHubGetPageStrategy ()
		{
			Init();
		}
		public override void Run(ApiClientCustomerHubGetPageContext context)
		{
			Execute(context);
		...
		public override Task RunAsync(ApiClientCustomerHubGetPageContext context)
		{
