...
namespace Locust.Modules.Base.Model.Application
{
    public class Full : BaseModel
    {
        ...
        private UniqueHubs _UniqueHubs;
        public UniqueHubs UniqueHubs
        {
            get
            {
                if (_UniqueHubs == null)
                    _UniqueHubs = new UniqueHubs();
                return _UniqueHubs;
            }
            set { _UniqueHubs = value; }
        }
        protected override IEnumerable<KeyValuePair<string, object>> GetProperties()
        {
            ...
            result.Add(new KeyValuePair<string, object>("UniqueHubs", UniqueHubs.Value));
