...
{
	public partial class StateGetByCodeStrategy : StateGetByCodeStrategyBase
    {

		public StateGetByCodeStrategy ():base()
		{
			Init();
		}

		public override void Run(StateGetByCodeContext context)
		{
		...
		public override Task RunAsync(StateGetByCodeContext context)
		{
